            ...
            <div className="w-full h-full flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 flex flex-col p-20 justify-center bg-primary text-white">
                    ...
                    <p className="max-w-md text-sm leading-relaxed text-center md:text-left">
                        Your gateway to the most trusted marketplace in Sri
                        Lanka. Buy and sell anything — from mobiles and
                        electronics to property and jobs — all in one place. Log
                        in to manage your ads, connect with buyers and sellers,
                        and make the most out of your local marketplace
                        experience.
                    </p>
                </div>
            </div>
